...
This project is indexed by GitNexus as **newstart** (25520 symbols, 44939 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

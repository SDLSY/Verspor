...
class DataCollectionService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START_COLLECTION = DataCollectionServiceContract.ACTION_START_COLLECTION
        const val ACTION_STOP_COLLECTION = DataCollectionServiceContract.ACTION_STOP_COLLECTION
        const val EXTRA_DEVICE_ADDRESS = DataCollectionServiceContract.EXTRA_DEVICE_ADDRESS
        const val EXTRA_DEVICE_NAME = DataCollectionServiceContract.EXTRA_DEVICE_NAME
    }
    ...
    private fun createNotification(content: String = "正在采集健康数据..."): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setSmallIcon(CommonR.drawable.ic_launcher_foreground)
